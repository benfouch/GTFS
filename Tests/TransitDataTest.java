...
class TransitDataTest {
    ...
    void testGetRoutesThroughStop(){
       ...
       assertEquals("No routes found through stop or stop ID invalid", TD.getRoutesThroughStop(badInput));
       assertEquals("No routes found through stop or stop ID invalid", TD.getRoutesThroughStop(notAStopID));
    }
